...
//		et1.setHint(s2);
		...
		ICallBack icb_tixian=new ICallBack() {
			...
			public void back(Object obj) {
				if(obj!=null)
				{
					...
					s2=NumberManager.getAddString(gd.body.repay_amt,gd.body.recharge_amt,2);
					tv_chishu.setText("剩余免费次数: "+gd.body.free_number+"次");
					tv_touzhi.setText("充值未投资"+s4+"元 "+"投资回款"+s3+"元");
					tv_keti.setText(s2+"元");
		...
		public void back(Object obj) {
			if(obj!=null)
			{
				...
				// tv2.setText(p.freeChargeCount);
				 tv_chishu.setText("剩余免费次数: "+p.freeChargeCount+"次");
			}
    ...
    private  void initView()
    {
    	...
    	// ll1=(LinearLayout) findViewById(R.id.ll_ll1);
         ...
         tv_touzhi=(TextView) findViewById(R.id.tv_touzhi);
         tv_chishu=(TextView) findViewById(R.id.tv_chishu);
...
//  		}
        ...
        // BankHelp.setBnak(tv1,null);
         ...
         String s1="提现至"+bank_name+"(尾号"+bank.substring(bank.length()-4,bank.length())+")";
         tv_bank.setText(s1);
    }
    Dialog dia=null;
	 private void initOn()
...
//				    tv_tv3.setText(NumberManager.getGeshiHua(residue, 2)+"元");
	...
	public void onClick(View v) {
		...
		case R.id.right:
			...
			intent.putExtra("url",SystemConfig.huodong_url+"/#!/help/tx");
			act.startActivity(intent);
			break;
		case R.id.tv_quanbu:
            et1.setText(s2);
