 ...
 *2.0主界面
 */
public class HomeActivity4 extends BaseActivity1 implements View.OnClickListener
{   
	public static HomeActivity4 ha;
	/**
    ...
    public static PageView1 pv1;
    public static PageView2 pv2;
    public static PageView3 pv3;
    public FundInfo fi;
    ...
    {    
    	...
    	ICallBack icb6=new ICallBack() {
			...
			public void back(Object obj) {
				if(obj!=null)
				{  
					TanChuan_data tc=(TanChuan_data) obj;
					final TanChuan t=tc.body;
					...
					ImageUrl iu=new ImageUrl(iv,t.icon);
					iu.start();
					...
					iv.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
						  ...
						  if(t.linkurl!=null&&!t.linkurl.equals(""))
						  {   
							  
							  Intent intent=new Intent(act,HuodongActivity2.class);
							  intent.putExtra("url",t.linkurl);
		...
		{
		  getTanChuanParam gtp=new getTanChuanParam();
		  ManagerParam mp=new ManagerParam();
		  mp.isShowDialog=false;
		  mp.isShowMsg=false;
		  TongYongManager2 tym=new TongYongManager2(this,icb6,gtp,mp);
		  tym.start();
		}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if(keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN){
			if(window!=null&&window.isShowing())
			{
				...
				Toast.makeText(HomeActivity4.this, getString(R.string.second_time_exit), Toast.LENGTH_SHORT).show();                                
