...
//取现状态
public class RedeemStatusActivity extends BaseActivity implements OnClickListener{
	...
	public void backEvent(){
		Intent intent3 = new Intent(RedeemStatusActivity.this, HomeActivity3.class); 
		BeikBankApplication.mSharedPref.putSharePrefInteger(BeikBankConstant.HOME_TYPE, 
				4);
		intent3.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		startActivity(intent3);
