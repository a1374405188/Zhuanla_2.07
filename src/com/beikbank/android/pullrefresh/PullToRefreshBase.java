...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private boolean isLanjie(float x1,float y1,float x2,float y2)
    {
    	boolean b=false;
    	float a1=y2-y1;
    	a1=Math.abs(a1);
    ...
    protected void addRefreshableView(Context context, T refreshableView) {
        ...
        //mRefreshableViewWrapper.setBackgroundColor(0x00f4f4f4);
    ...
    {
    	HeaderLoadingLayout hll=(HeaderLoadingLayout) mHeaderLayout;
    	hll.setTextColor(color);
    }
    /**
     * 添加Header和Footer
     * 
