 ...
 * @since 2013-8-15
 */
public class PullToRefreshListView2 extends PullToRefreshBase2 implements OnScrollListener {
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
    	...
    	ScrollListviewDelete listView=new ScrollListviewDelete(context);
        mListView = listView;
