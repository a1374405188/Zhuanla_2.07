...
import com.beikbank.android.pullrefresh.ILoadingLayout.State;
 ...
 * @param <T>
 */
public abstract class PullToRefreshBase2 extends LinearLayout implements IPullToRefresh2 {
	public boolean isLanjie=false;
    /**
     * 定义了下拉刷新和上拉加载更多的接口。
     * 
     * @author Li Hong
    ...
    public interface OnRefreshListener {
         ...
         */
        void onPullDownToRefresh(final PullToRefreshBase2 refreshView);
         ...
         * @param refreshView 刷新的View
         */
        void onPullUpToRefresh(final PullToRefreshBase2 refreshView);
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
    	...
    	if(!((ScrollListviewDelete)mRefreshableView).isLast)
    	{
    		return false;
    	}
	...
	private float mLastMotionY2;// 记住上次Y触摸屏的位置
	...
	private boolean isIntercept(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (!isLock) {
				...
				float deltay = Math.abs(mLastMotionY2 - y);
				mLastMotionX = x;
				mLastMotionY2 = y;
    ...
    protected void addRefreshableView(Context context, View refreshableView) {
        ...
        mRefreshableViewWrapper.setBackgroundColor(0xfff4f4f4);
    ...
    protected void startRefreshing() {
        ...
        if (null != mRefreshListener) {
            ...
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    mRefreshListener.onPullDownToRefresh(PullToRefreshBase2.this);
                }
            }, getSmoothScrollDuration()); 
        }
    }
    ...
    protected void startLoading() {
        ...
        if (null != mRefreshListener) {
            ...
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    mRefreshListener.onPullUpToRefresh(PullToRefreshBase2.this);
                }
            }, getSmoothScrollDuration()); 
        }
    }
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                PullToRefreshBase2.this.postDelayed(this, 16);// SUPPRESS CHECKSTYLE
            }
        }
