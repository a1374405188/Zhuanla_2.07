 ...
 *
 */
public class HongbaoUtil2_v2 {
	Activity act;
	public HongbaoUtil2_v2(Context act)
	{
...
//					 holder.tv5.setVisibility(View.GONE);
//				}	
			int d1=(int) NumberManager.StoD(hb.floor_term);
			int d2=(int) NumberManager.StoD(hb.upper_term);
			if(d1==0&&d2==0)
			{
