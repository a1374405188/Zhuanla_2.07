 ...
 * 钱包请求充值确认
 */
public class Qianbao2Manager extends ThreadManager{
	String tag="Qianbao2Manager";
	QianbaoParam2 qp1;
	public Qianbao2Manager(Activity act,ICallBack icb,QianbaoParam2 qp1)
	{
		this.act=act;
		this.icb=icb;
		this.qp1=qp1;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.qianbao2(Qianbao1_data.class,null,qp1);
