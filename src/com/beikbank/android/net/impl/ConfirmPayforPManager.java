 ...
 * 
 */
public class ConfirmPayforPManager extends ThreadManager{
	String tag="ConfirmPayforPManager";
	ConfirmPayforPParam cpp;
	public ConfirmPayforPManager(Activity act,ICallBack icb,ConfirmPayforPParam cpp)
	{
		this.act=act;
		this.icb=icb;
	    this.cpp=cpp;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.confirmPayforP(ConfirmPay_data.class,null,cpp);
