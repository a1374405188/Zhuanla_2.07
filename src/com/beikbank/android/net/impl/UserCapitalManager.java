 ...
 * 获得用户资产管理
 */
public class UserCapitalManager extends ThreadManager{
	String tag="UserCapitalManager";
	TotalMoneyParam tlp;
	public UserCapitalManager(Activity act,ICallBack icb,TotalMoneyParam tlp)
	{
		this.act=act;
		this.icb=icb;
		this.tlp=tlp;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.getUserCapital(UserCapital_data.class,null,tlp);
