 ...
 * 活动管理
 */
public class ActionManager extends ThreadManager{
    String tag="ActionManager";
	public ActionManager(Activity act,ICallBack icb)
	{
		this.act=act;
		this.icb=icb;
		init2();
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.getActivity(Action_data.class,null,null);
