...
import com.beikbank.android.data.CheckBankAndPhoneR_data;
 ...
 * 
 */
public class CheckBankAndPhoneRManager extends ThreadManager
{
	String tag="CheckBankAndPhoneRManager";
	CheckBankAndPhoneRParam cbr;
	public CheckBankAndPhoneRManager(Activity act,ICallBack icb,CheckBankAndPhoneRParam cbr)
	{
		this.act=act;
		this.icb=icb;
		this.cbr=cbr;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.checkBankAndPhoneR(CheckBankAndPhoneR_data.class,null,cbr);
