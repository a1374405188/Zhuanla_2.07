 ...
 * 
 */
public class ReqPayforPManager extends ThreadManager{
	String tag="ReqPayforPManager";
	ReqPayforPParam rpp;
	public ReqPayforPManager(Activity act,ICallBack icb,ReqPayforPParam rpp)
	{
		this.act=act;
		this.icb=icb;
		this.rpp=rpp;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.reqPayforP(ReqPayforP_Data.class,null,rpp);
