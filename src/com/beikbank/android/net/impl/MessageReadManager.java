 ...
 * 将消息标记为已读
 */
public class MessageReadManager extends ThreadManager{
	 String tag="MessageReadManager";
		
		private MessageReadParam mp;
		public MessageReadManager(Activity act,ICallBack icb,MessageReadParam  messageParam)
		{
			this.act=act;
			this.icb=icb;
			 mp=messageParam;
			    ...
			    icbh=new ICallBackHnadler() {
				 ...
				 icbn=new ICallBackNet() {
					...
					public void back(Handler handler) throws Exception {
						...
						Object obj=im.readMessage(Base_data.class,null,mp);
