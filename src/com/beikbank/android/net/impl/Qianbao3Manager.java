 ...
 * 钱包请求取现
 */
public class Qianbao3Manager extends ThreadManager{
	String tag="Qianbao3Manager";
	QianbaoParam1 qp1;
	public Qianbao3Manager(Activity act,ICallBack icb,QianbaoParam1 qp1)
	{
		this.act=act;
		this.icb=icb;
		this.qp1=qp1;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.qianbao3(Qianbao2_data.class,null,qp1);
