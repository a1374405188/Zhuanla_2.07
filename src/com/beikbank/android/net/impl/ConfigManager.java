 ...
 *2015-5-11
 */
public class ConfigManager extends ThreadManager
{
	String tag="ConfigManager";
	public ConfigManager(Activity act,ICallBack icb)
	{
		this.act=act;
		this.icb=icb;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.getConfigQQ(Config_data.class,null,null);
