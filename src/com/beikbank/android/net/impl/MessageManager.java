...
public class MessageManager extends ThreadManager{
     String tag="MessageManager";
	
	private MessageParam mp;
	public MessageManager(Activity act,ICallBack icb,MessageParam messageParam)
	{
		this.act=act;
		this.icb=icb;
		 mp=messageParam;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.getMessage(Message_data.class,null,mp);
