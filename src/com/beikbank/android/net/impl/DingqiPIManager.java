 ...
 * 定期产品详细信息
 */
public class DingqiPIManager extends ThreadManager{
	String tag="DingqiPIManager";
	DingqiPIParam dpi;
	public DingqiPIManager(Activity act,ICallBack icb,DingqiPIParam dpi)
	{
		this.act=act;
		this.icb=icb;
		this.dpi=dpi;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.getDingqiPI(DingqiPI_data.class,null,dpi);
