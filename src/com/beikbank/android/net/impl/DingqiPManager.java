 ...
 * 
 */
public class DingqiPManager extends ThreadManager{
	String tag="DingqiPManager";
	public DingqiPManager(Activity act,ICallBack icb)
	{
		this.act=act;
		this.icb=icb;
		init2();
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.getDingqiP(DingqiP_data.class,null,null);
