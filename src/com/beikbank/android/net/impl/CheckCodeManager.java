...
public class CheckCodeManager {
	 ...
	 * @param icb
	 */
   public CheckCodeManager(Activity act,String phoneNumber,String verifiId,String verificode,ICallBack icb)
   {
	   this.act=act;
	   this.icb=icb;
   ...
   ICallBackNet icbn=new ICallBackNet() {
	...
	public void back(Handler handler) throws Exception {
		 IBusiness im= (IBusiness) NetServicesFactory.getNetServices(act,NetServicesFactory.BUSINESS);
		  ...
		  CheckCodeParam ccp=new CheckCodeParam();
...
// 	      }
		  Object obj=null;
		  obj=im.CheckCode(CheckCode_data.class,null,ccp);
