 ...
 * 
 */
public class ActionListManager extends ThreadManager{
	 String tag="ActionListManager";
		public ActionListManager(Activity act,ICallBack icb)
		{
			this.act=act;
			this.icb=icb;
			init2();
			    ...
			    icbh=new ICallBackHnadler() {
				 ...
				 icbn=new ICallBackNet() {
					...
					public void back(Handler handler) throws Exception {
						...
						Object obj=im.getActionList(Actionlist_data.class,null,null);
