 ...
 * 
 */
public class ActionInfoManager extends ThreadManager{
	String tag="ActionListManager";
	ActionInfoParam aip;
	public ActionInfoManager(Activity act,ICallBack icb,ActionInfoParam aip)
	{
		this.act=act;
		this.icb=icb;
		this.aip=aip;
		    ...
		    icbh=new ICallBackHnadler() {
			 ...
			 icbn=new ICallBackNet() {
				...
				public void back(Handler handler) throws Exception {
					...
					Object obj=im.getActionInfo(ActionInfo_data.class,null,aip);
